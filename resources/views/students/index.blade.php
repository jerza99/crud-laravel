            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6 lg:p-8">
                <div class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <table class="table-auto w-full">
                        <thead>
                            <tr>
                                <th class="px-4 text-gray-900 dark:text-white text-center">Id</th>
                                <th class="px-4 text-gray-900 dark:text-white text-center">Name</th>
                                <th class="px-4 text-gray-900 dark:text-white text-center">Age</th>
                                <th class="px-4 text-gray-900 dark:text-white text-center">Action</th>
                            </tr>
                        </thead>
                                ...
                                <tr>
                                    ...
                                    <td class="border px-4 py-2 text-center">
                                        <div class="flex justify-center">
                                            ...
                                            <button type="button" onclick="confirmDelet({{ $student->id }})" class="bg-pink-400 dark:bg-pink-600 hover:bg-pink-500 dark:hover:bg-pink-700 text-white font-bold py-2 px-4 rounded">Delete</button>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
